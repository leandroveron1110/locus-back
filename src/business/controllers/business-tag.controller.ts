...
import {
  ...
  UsePipes,
  ValidationPipe,
  Inject, // Necesitamos Inject para el token
} from '@nestjs/common';
...
export class BusinessTagController {
  ...
  ): Promise<{ message: string }> { // Retorna un objeto con un mensaje
  ...
  ): Promise<BusinessTagDetails[]> { // El tipo de retorno es BusinessTagDetails[]
